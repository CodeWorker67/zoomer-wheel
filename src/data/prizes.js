...
export const WHEEL_PRIZES = [
  { id: 'vpn_2w', rim: '2 НЕДЕЛИ', kind: 'vpn', fill: '#1e2f4f', weight: 25 },
  { id: 'cash_100k', rim: '100 000 ₽', kind: 'money', fill: '#c97812', glow: '#ffb347', weight: 0 },
  { id: 'vpn_1m', rim: '1 МЕСЯЦ', kind: 'vpn', fill: '#1e2f4f', weight: 15 },
  { id: 'disc_50', rim: 'СКИДКА', kind: 'percent', value: '50%', fill: '#2a5088', weight: 5 },
  { id: 'disc_10', rim: 'СКИДКА', kind: 'percent', value: '10%', fill: '#1a2848', weight: 25 },
  { id: 'iphone', rim: 'IPHONE 18 PRO', kind: 'apple', fill: '#c97812', glow: '#ffb347', weight: 0 },
  { id: 'vpn_3m', rim: '3 МЕСЯЦА', kind: 'vpn', fill: '#3d4f6a', weight: 5 },
  { id: 'disc_30', rim: 'СКИДКА', kind: 'percent', value: '30%', fill: '#2a5088', weight: 15 },
